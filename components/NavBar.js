                ...
                {session ?
                    <>
                        <div className="nav-dropdown relative">
                            ...
                            <div id="dropdown" className={`z-10 ${dropDown ? 'hidden' : ''} absolute left-8 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700`}>
                        ...
                        <button type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-1 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 cursor-pointer" onClick={() => { signOut() }}>Logout</button>
                    </>
                    :
                    <Link href={"/login"}>
